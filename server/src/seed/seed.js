  ...
  const universities = await University.insertMany([
    {
      ...
      researchAreas: ['IoT', 'Water & Sanitation', 'Machine Learning', 'Renewable Energy', 'Public Health Informatics'],
      laboratories: ['IoT Lab', 'Signal Processing Lab', 'Environmental Testing Lab'],
      expertiseTags: ['Water & Sanitation', 'Electricity', 'Healthcare', 'Government Services'],
    ...
    },
    {
      ...
      researchAreas: ['Agriculture', 'Environment', 'Structural Engineering'],
      laboratories: ['Biotech Lab', 'Materials Lab'],
      expertiseTags: ['Agriculture', 'Environment', 'Disaster Management'],
    ...
    },
    {
      ...
      expertiseTags: ['Healthcare', 'Education', 'Government Services'],
    ...
    },
    {
      ...
      researchAreas: ['Transport', 'Electricity', 'Agriculture', 'Waterlogging Management'],
      laboratories: ['Hydraulics Lab', 'Transportation Engineering Lab'],
      expertiseTags: ['Transport', 'Electricity', 'Agriculture', 'Water & Sanitation'],
  ...
  const partners = await IndustryPartner.insertMany([
    {
      ...
      capabilities: ['Funding', 'Rural Development', 'Water & Sanitation', 'Healthcare'],
    ...
    },
    {
      ...
      capabilities: ['Water & Sanitation', 'IoT', 'Sensors', 'Agriculture'],
    ...
    },
    {
      ...
      sector: 'Mining / CSR',
      capabilities: ['Funding', 'Infrastructure', 'Environment', 'Electricity'],
  ...
  for (const [idx, c] of baseChallenges.entries()) {
    const challenge = new Challenge({
      ...
      aiAnalysis: {
        ...
        severity: c.severity,
        priority: ({ Low: 'LOW', Medium: 'MEDIUM', High: 'HIGH', Critical: 'CRITICAL' })[c.severity],
        priorityScore: Math.round(50 + Math.random() * 45),
        innovationScore: Math.round(40 + Math.random() * 50),
        confidence: 0.8,
        reason: `Priority reflects the reported risk and impact on ${c.affectedPopulation} people.`,
        aiClassified: true,
